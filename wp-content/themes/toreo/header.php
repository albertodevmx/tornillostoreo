...
<header class="grupo total header">
    ...
    <div class="grupo">
        ...
        <div class="caja base-70 web-75 header__contenedor">
            <div class="header__titulo">
                <h2>Comercializadora y Distribuidora de</h2>
                <h1><a href="http://tornillostoreo.com">Tornillos y Herramientas Toreo S.A. de C.V.<br></a></h1>
            </div>
            ...
            <div class="header__contenedor__facebook">
                ...
                <img id="whats_tel" title="Télefono: 55-4325-0149" src="<?php echo get_template_directory_uri(); ?>/img/whatsapp_icon.png" alt="<?php bloginfo('name'); ?>" style="width: auto; height: 50px;">
            </div>
        </div>
